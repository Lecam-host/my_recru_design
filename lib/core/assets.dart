class SvgIconConstants {
  static const String path = 'assets/icons';
  static const String favorite = '$path/favorite.svg';
  static const String recent = '$path/recent.svg';
  static const String contact = '$path/contact.svg';
  static const String appIcon = '$path/app_icon.svg';
